...
const schoolList = [
    ...
    'Franciscan Missionaries of Our Lady Uiversity',
    ...
    'Hofstra University',
    'Hollins University',
    'Holy Apostles Collge and Seminary',
    'Holy Cross College',
    'Holy Family College',
...
module.exports = {
	up: (queryInterface) => {
	  ...
	  return queryInterface.bulkInsert('Schools',insertData);
	},
